...
export default function BlogPage() {
  return (
    <div className="flex flex-col w-full bg-white">
      ...
      <section className="w-full max-w-7xl mx-auto mt-8 px-4 sm:px-6 lg:px-8 pb-12 md:pb-16">
        <div className="flex flex-col lg:flex-row gap-8 lg:gap-12">
          ...
          <div className="lg:w-[380px] xl:w-[420px] flex-shrink-0">
            <div className="lg:sticky lg:top-28">
              ...
              >
                {/* Portrait image — full width within its column */}
                <Image
                ...
                <div className="absolute bottom-0 left-0 right-0 p-6 sm:p-8">
                  <h1 className="text-xl sm:text-2xl lg:text-2xl xl:text-3xl font-extrabold text-white leading-snug drop-shadow-lg">
          ...
          {/* Right Column — Blog Text Content */}
